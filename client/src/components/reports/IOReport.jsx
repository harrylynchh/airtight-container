    ...
    <div className='repContainer ioContainer'>
      ...
      <div className='card'>
        ...
        <div className="reportDesc">
          <p>Generate a report with the details of all inbound and outbound containers within a set interval of dates.</p>
        </div>
        <form onSubmit={submitForm} method='post'>
          <div className="dateInputs">
            <input type='date' className='obDate'></input> <span>to</span> <input type='date' className='obDate'></input>
          </div>
