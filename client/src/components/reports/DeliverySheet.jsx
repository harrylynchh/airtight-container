              ...
              <div className="repRow">
                ...
                <span>
                  <input
                    ...
                    onChange={setContact}
                    placeholder="Onsite Contact:"></input>
                </span>
              </div>
              <div className="repRow">
                <span>
                  <input
                    ...
                    placeholder="Container Orientation:"></input>
                </span>
                <span>
                  <input
                    type="text"
                    ...
                    onChange={setPickup}
                    placeholder="Payment Details:"></input>
                </span>
              </div>
