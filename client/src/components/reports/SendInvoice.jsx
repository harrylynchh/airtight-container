    ...
    <div className="repContainer">
      <div className="card">
        ...
        <div className="reportDesc">
          <p>
            Create an invoice and send a copy to both the customer and company with an option to
            print. <br /> <br />
            <span className="nowrap">Select Unit(s) (Shift+Click to select multiple units):</span>
          </p>
        </div>
        <label>
          <select
            ...
            className="repSelect">
            {options.map((option) => {
              return <option value={option.unit_number}>{option.unit_number}</option>;
            })}
          </select>
        </label>
