        ...
        <nav>
          {user.permissions !== 'unauthorized' && (
            ...
            <>
              ...
              <li><a href="/sold">Sold Boxes</a></li>
              <li><a href="/reports" target='_blank'>Reports</a></li>
              <li><a href="/dashboard">Dashboard</a></li>
            </>
            }
            <li><a href="/yardview">Yard View</a></li>
            <li><a href="/add">Add A Box</a></li>
            <li><a href="/help">Help</a></li>
          </ul>
          )}
        </nav>
        <div className='profileContainer'>
          <img className='userProfile' src={profile} alt='profile' width={userWidth} onClick={() => setShowUserOps(!showUserOps)} onMouseOver={() => changeWidth()} onMouseLeave={() => changeWidth()}></img>
          {showUserOps && <div className='profileDropdown'>
            <div>{user.email === 'unauthorized' ? 'Guest' : user.email}</div>
            <button className='logoutBtn authBtn' onClick={() => logout()}>Logout</button>
          </div>}
        </div>
    </div>
  )
