...
function OutboundForm({ container, save, close }) {
  ...
  const setOutboundTrucker = (e) => {
    setUpdatedContainer((prev) => ({
      ...prev,
      outbound_trucker: e.target.value
    }));
  };
  ...
  const setReleaseNumber = (e) => {
    setUpdatedContainer((prev) => ({
      ...prev,
      release_number: e.target.value
    }));
  };
  const setTruckingRate = (e) => {
    setUpdatedContainer((prev) => ({
      ...prev,
      trucking_rate: e.target.value
    }));
  };
  const setModPrice = (e) => {
    setUpdatedContainer((prev) => ({
      ...prev,
      modification_price: e.target.value
    }));
  };
  const setDate = (e) => {
      ...
      <form onSubmit={submitForm} className="update">
        <table>
          <tbody>
            <tr>
              <td>
                <span className="editSubTitle">Trucker:</span>
              </td>
              <td>
                <input
                  type="text"
                  onChange={setOutboundTrucker}
                  value={updatedContainer.outbound_trucker}
                  maxLength="20"></input>
              </td>
              <td>
                <span className="editSubTitle">Destination:</span>
              </td>
              <td>
                <input
                  type="text"
            ...
            <tr>
              <td>
                <span className="editSubTitle">Sale Price:</span>
              </td>
              <td>
                <input
                  type="text"
              ...
              <td>
                <span className="editSubTitle">Release Number:</span>
              </td>
              <td>
                <input
                  type="text"
            ...
            <tr>
              <td>
                <span className="editSubTitle">Trucking Rate:</span>
              </td>
              <td>
                <input
                  type="text"
                  onChange={setTruckingRate}
                  value={updatedContainer.trucking_rate}
                  maxLength="15"></input>
              </td>
              <td>
                <span className="editSubTitle">Mod Price:</span>
              </td>
              <td>
                <input
                  type="text"
                  onChange={setModPrice}
            ...
            <tr>
              <td>
                <span className="editSubTitle">Outbound Date:</span>
              </td>
              <td>
                <input
                  type="datetime-local"
